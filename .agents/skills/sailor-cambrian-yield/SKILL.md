...
## Known Sailor issues encountered (v2.2.1, all fixed in v2.3.0)

Reported to Sail and fixed in v2.3.0 (issues #225, #226, #227). Left here because anyone on an older version will still hit them.
